...
function MyPlate() {
  ...
  const generateWeekForDate = (
    dateToGenerate
  ) => {

    const targetDate =
      new Date(dateToGenerate);
  ...
  const remainingCal =
    Number(goalData.tdee || 0) -
    Number(totals.totalCal || 0);
  ...
  const handleSavePlan =
    async () => {
      ...
      try {
        ...
        const response =
          await fetch(
            "http://localhost:5000/api/save-plan",
            {
              method: "POST",
              headers: {
                "Content-Type":
        ...
        if (response.ok) {
          ...
          alert(
            `เกิดข้อผิดพลาดจากระบบ: ${errData.message}`
          );
    ...
    <div className="my-plate-container">
              ...
              >
                ...
                {categoryMeals.length > 0 ? (
                        ...
                        >
                          ...
                          <div className="cfi-image-wrapper">
                            ...
                            <div className="cfi-overlay">
                              ...
                              <h3 className="cfi-name">
                                {meal.name}
                              </h3>

                              <span className="cfi-kcal">
                                {(
                                  meal.calPerUnit *
                                  meal.qty
                                ).toFixed(0)} kcal
                  ...
                  <p className="empty-meal">
                    ยังไม่มีรายการอาหารสำหรับมื้อนี้
                  </p>
                ...
                <button
                  onClick={() =>
                    navigate(
                      `/SearchFood?type=${category.title}`
                    )
                  }
      ...
      >
        ...
        <div className="myplate-nutrition-grid">
          ...
          <NutritionBar
            label="น้ำตาล"
            current={totals.totalSugar}
            limit={goalData.sugar}
            unit="g"
          />
        ...
        <div className="cute-calendar-card">
          ...
          <div className="calendar-header-title">
            ...
            <div
              className="date-picker-library-wrapper"
              ref={calendarRef}
            >

              <button
                type="button"
                className={`cute-calendar-dropdown-btn ${showCalendar
                    ? "active"
                    : ""
                  }`}
                onClick={() =>
            ...
            <h3>
              เลือกวันที่ต้องการบันทึกแผน
            </h3>

          </div>

          <p className="calendar-subtitle">
            *สามารถเลือกได้หลายวัน
          </p>
            ...
            {currentWeekDays.map(
              (day) => {
                ...
                return (
                  ...
                  <div
                    key={day.dateString}
                    className={`cute-date-item ${isSelected
                        ? "selected"
                        : ""
                      } ${day.isToday
                        ? "today"
...
function NutritionBar({
  ...
  return (
    ...
    <div
      className={`macro-progress-card ${isFullWidth
          ? "span-full"
          : ""
        } ${className || ""}`}
    >

      <span className="macro-card-title">
        {label}
      </span>
      ...
      <div className="plate-macro-track">
        ...
        <div
          className={`plate-macro-fill ${statusClass}`}
          style={{
            width: `${fillWidth}%`
          }}
        />
